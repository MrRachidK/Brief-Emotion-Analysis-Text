...
y_pred5, dataframe5 = predict_model(model5, text_test5, X_test5)
...
y_pred6, dataframe6 = predict_model(model6, text_test6, X_test6)
...
y_pred7, dataframe7 = predict_model(model7, text_test7, X_test7)
...
y_pred8, dataframe8 = predict_model(model8, text_test8, X_test8)
accuracy8 = calculate_accuracy_score(y_test8, y_pred8)

joblib.dump([dataframe5, accuracy5, dataframe6, accuracy6, dataframe7, accuracy7, dataframe8, accuracy8, y_pred5, y_pred6, y_pred7, y_test5, y_test6, y_test7], filename_xgboost)